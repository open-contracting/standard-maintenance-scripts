...
pip install ruff 'jscc>=0.3.0' json-merge-patch jsonref jsonschema ocdskit packaging pytest requests \
    rfc3339-validator rfc3986-validator setuptools tomli # Python 3.10 or less
