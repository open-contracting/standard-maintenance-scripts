...
TECH_SUPPORT_PRIORITIES = {
  # Tools
  'json-schema-random' => ['✴️'],
  'lib-cove-ocds' => ['-'],
  'kingfisher' => ['✴️✴️', 'key tool'],
  'ocds-faker' => ['✴️'],
  'ocds-merge' => ['✴️✴️✴️', 'reference implementation'],
  'ocds-show' => ['✴️'],
  'ocds-show-ppp' => ['✴️'],
  'ocdskit' => ['✴️✴️', 'key tool'],
  'sample-data' => ['✴️✴️', 'key resource, frequently visited'],
  'standard-development-handbook' => ['✴️✴️', 'internal, key documentation'],
  'standard-maintenance-scripts' => ['✴️✴️', 'internal, quality assurance'],
  # Extension tools
  'extension-explorer' => ['✴️✴️✴️', 'extensions documentation'],
  'extensions-data-collector' => ['-'],
  'extension_creator' => ['✴️'],
  'extension_registry.py' => ['✴️✴️✴️', 'common dependency'],
  # Documentation dependencies
  'ocds-babel' => ['✴️✴️✴️', 'dependency of `standard` and profiles'],
  'standard_theme' => ['✴️✴️✴️', 'dependency of `standard` and profiles'],
  'sphinxcontrib-opencontracting' => ['✴️✴️✴️', 'dependency of `standard`'],
  # Miscellaneous repositories
  'api-specification' => ['✴️', 'draft'],
  'european-union-support' => ['✴️', 'scratch pad'],
  'extension_registry' => ['✴️✴️✴️', 'authoritative resource'],
  'glossary' => ['✴️✴️', 'potential future key resource'],
  'infrastructure' => ['✴️✴️✴️'],
  'ocds-extensions' => ['-'],
  'standard' => ['✴️✴️✴️', 'core documentation'],
  # Templates
  'standard_extension_template' => ['✴️✴️', 'public resource'],
  'standard_profile_template' => ['✴️', 'internal template'],
  # Legacy
  'open-contracting.github.io' => ['✴️'],
  'standard-legacy-staticsites' => ['✴️'],
}
